...
import 'package:the_academy/controller/screens_controllers/all_users_exam_screen_controller.dart';
...
class AllUsersExamScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<AllUsersExamScreenController>(
      init: AllUsersExamScreenController(),
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return UserListWidget(
                                    ...
                                    trailingWidget: Container(
                                      ...
                                      child: Text(
                                        getDoubleNumber(item.mark).toString(),
                                        textAlign: TextAlign.center,
                                        style: TextStyle(
