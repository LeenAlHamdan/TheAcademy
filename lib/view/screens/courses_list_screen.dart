...
import 'package:the_academy/controller/screens_controllers/courses_list_screen_controller.dart';
...
class CoursesListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CoursesListScreenController>(
      init: CoursesListScreenController(),
      builder: (screenController) => Scaffold(
        appBar: MyAppBar(
          title: Text(
              screenController.isMyCourses
                  ? 'my_courses_title'.tr
                  : Get.locale == const Locale('ar')
                      ? screenController.subject!.nameAr
                      : screenController.subject!.nameEn,
                                  ...
                                  ? Padding(
                                      padding: EdgeInsets.symmetric(
                                          ...
                                          vertical: screenController.isSearching
                                              ...
                                              : 8),
                                      child: EmptyWidget(
                                        title: screenController.isMyCourses &&
                                                screenController
                                                        .dropDownFilterValue ==
                                                    screenController
                                                        .defaultFilter
                                            ? 'you_dont_have_courses_yet'.tr
                                            : null,
                                      ),
                                    )
        ...
        floatingActionButton: FloatingActionButton(
          heroTag: "btn2",
          onPressed: !screenController.userController.userCanEditCourse
              ? null
              : () => Get.toNamed('/add-course-screen',
                  arguments: (screenController.subject != null)
                      ? {
                          "subjectId": screenController.subject!.id,
                          "subjectNameAr": screenController.subject!.nameAr,
                          "subjectNameEn": screenController.subject!.nameEn,
                        }
                      : null),
