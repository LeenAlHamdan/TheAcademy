...
class S {
  static const Color pink = Color.fromRGBO(255, 69, 80, 1);
  static Color pink300 = pink.withOpacity(.3);

  static innerBoxShadow({Color? color}) => [
        BoxShadow(color: (color ?? Colors.black).withOpacity(.13)),
        BoxShadow(
